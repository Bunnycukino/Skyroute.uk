...
export default function LogisticInput() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.flight_number || !formData.flight_date || !formData.signature || !formData.pieces || !formData.destination || !formData.base) {
        ...
        <Card className="shadow-lg mb-6">
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              {/* The original NEW BUILD card from the "Find C209 Card" section is removed, as the new one is placed within the form */}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="base" className="text-base font-semibold">
                  Base *
                </Label>
                <Input
                  id="base"
              ...
              {foundShipment && foundShipment.is_new_build && (
                <Card className="bg-yellow-50 border-yellow-200">
                  <CardContent className="p-4">
                    <h4 className="font-semibold text-yellow-900 mb-2">📝 NEW BUILD Mode</h4>
                    <p className="text-sm text-yellow-800">
                      Tworzysz nową przesyłkę z C209 = "NEW BUILD". Wypełnij wszystkie pola powyżej.
                    </p>
                  </CardContent>
                </Card>
              )}

...
import { ClipboardList, Upload, Package, Hash, FileText, RefreshCw, LogOut } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const allNavigationItems = [
  ...
  {
    title: "REALLOCATION",
    url: createPageUrl("ReallocationRegister"),
    icon: RefreshCw,
    roles: ['admin'],
  },
  {
        ...
        <Sidebar className="border-r border-blue-100 hidden md:flex">
            ...
            <SidebarGroup className="mt-4">
              ...
              <SidebarGroupContent>
                <div className="px-3 py-3 space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg border border-purple-100"> {/* Changed to purple */}
                    <span className="text-sm font-medium text-purple-800">Outbound</span> {/* Changed to purple */}
                    <Badge className="bg-purple-600 hover:bg-purple-700"> {/* Changed to purple */}
          ...
          <SidebarFooter className="border-t border-blue-100 p-4">
            <Button
              ...
              variant="outline"
              className="w-full justify-start gap-2 hover:bg-red-50 hover:text-red-700 hover:border-red-300"
            >
        ...
        <main className="flex-1 flex flex-col">
          ...
          <header className="bg-white border-b border-blue-100 px-4 py-4 md:hidden shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2"> {/* Added a div to group badge and button */}
                {expiredCount > 0 && (
